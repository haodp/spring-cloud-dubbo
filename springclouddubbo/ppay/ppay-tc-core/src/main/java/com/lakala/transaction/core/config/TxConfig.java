...
public class TxConfig {
    ...
    /**
     * 提供不同的序列化对象 {@linkplain com.lakala.transaction.common.enums.SerializeProtocolEnum}
     */
    ...
    /**
     * 线程池的拒绝策略 {@linkplain com.lakala.transaction.common.enums.RejectedPolicyTypeEnum}
     */
    private String rejectPolicy = "Abort";

    /**
     * 线程池的队列类型 {@linkplain com.lakala.transaction.common.enums.BlockingQueueTypeEnum}
     */
    ...
    /**
     * 补偿存储类型 {@linkplain com.lakala.transaction.common.enums.CompensationCacheTypeEnum}
     */
